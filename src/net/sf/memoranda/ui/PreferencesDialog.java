/*
 * File: 	PreferencesDialog	
 * Author:	alexeya & CST316 2016 Spring A Team Irvine
 * Date:	2/23/2016
 * 
 * Description: Preferences dialog popup
 */
 ...
 */
	...
	void apply() {
		...
		if(this.minTaskbarRB.isSelected()){
			Configuration.put("ON_MINIMIZE", "taskbar");
		}else{
