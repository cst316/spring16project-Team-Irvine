			...
			public void hyperlinkUpdate(HyperlinkEvent e) {
				if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
					...
					if (d.equalsIgnoreCase("memoranda:events"))
						...
						refresh(CurrentDate.get());
						System.out.println("Sticker added");
						...
						if (!dlg.CANCELLED) {
						 ...
						 // TODO: add export sticker
						 final JFileChooser parent = new JFileChooser();
						 String name = JOptionPane.showInputDialog(parent,Local.getString("Enter a name to for the exported file (text)"),null);
						 new ExportSticker(name).export("txt");
						 //JOptionPane.showMessageDialog(null,name);
					}else if (d.startsWith("memoranda:exportstickersh")) {
						 // TODO: add export sticker
						 final JFrame parent = new JFrame();
						 String name = JOptionPane.showInputDialog(parent,Local.getString("Enter a name to for the exported file (HTML)"),null);
						 new ExportSticker(name).export("html");
						 //JOptionPane.showMessageDialog(null,name);
					}else if (d.startsWith("memoranda:importstickers")) {
						final JFrame parent = new JFrame();
						String name = JOptionPane.showInputDialog(parent,Local.getString("Enter a filename to import"),null);
